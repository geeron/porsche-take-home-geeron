...
export const TileBackground: React.FC<React.PropsWithChildren<ChildProps>> = ({
  children,
}) => {
  return <div className="absolute h-full w-full">{children}</div>;
};

export const TileContent: React.FC<React.PropsWithChildren<ChildProps>> = ({
  children,
}) => {
  return (
